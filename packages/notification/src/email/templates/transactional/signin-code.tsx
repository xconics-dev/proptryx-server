          ...
          <Section>
            <Section className="bg-bg border-stroke border">
              ...
              <Section className="mobile:px-6! px-8 pt-8 pb-10">
                <Text className="font-32 text-fg m-0 font-sans">Sign In to Proptryx</Text>
                ...
                <Text className="font-14 font-inter text-fg-2 m-0 mt-2">
                  Enter the code above on your device to sign in to Proptryx. This code will expire
                  in <span className="font-semibold">{codeExpiryTime}</span> minutes.
                </Text>
