...
export const env = createEnv({
  server: {
    ...
    FIREBASE_PROJECT_ID: z.string().min(1, "FIREBASE_PROJECT_ID is required for FCM"),
    FIREBASE_CLIENT_EMAIL: z.string().email("FIREBASE_CLIENT_EMAIL must be a valid email"),
    FIREBASE_PRIVATE_KEY: z.string().min(1, "FIREBASE_PRIVATE_KEY is required for FCM"),
  },
  runtimeEnv: {
