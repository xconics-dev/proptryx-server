...
export async function findRoleById(id: string, organizationId: string) {
  return db
    .select()
    .from(rbacRole)
    .where(
...
export async function fetchRoleList(query: RoleListQuery, organizationId: string) {
...
export async function findRoleDetailsById(id: string, organizationId: string) {
